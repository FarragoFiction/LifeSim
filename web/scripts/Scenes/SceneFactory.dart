...
abstract class SceneFactory {
   ...
   static void initScenes() {
       ...
       GenericScene FIREMAN = new GenericScene("Be A Fireman",<SVP>[new SVP(StatFactory.JOBFLAKES,3), new SVP(StatFactory.COMMERCE,2)], "${GenericScene.OWNERNAME} works hard as a firefighter, saving lives.","Firestation.png",null, <Scene>[DIEINFIRE,BEFIREHERO],triggerStatsGreater:<SVP>[new SVP(StatFactory.GRADEMOXY,1)]);
       ...
       BERICH = new GenericScene("Be Rich",<SVP>[new SVP(StatFactory.ESTEEM,10)], "${GenericScene.OWNERNAME} is now rich.","GoodMansion.png",null, <Scene>[],triggerChance: 0.9,triggerStatsGreater:<SVP>[new SVP(StatFactory.COMMERCE,StatFactory.COMMERCE.maxValue)]);
